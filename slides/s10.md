...
Without `join`s, you get a table containing all rows from each table, combined with all the other rows in every other table.
...
Note: `OUTER` is optional and may be excluded.

Try each `JOIN` and see the results.
